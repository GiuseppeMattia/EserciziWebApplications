    ...
    public List<Ristorante> findAllByPiattoName(String name) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            while (resultSet.next()) {
                RistoranteProxy ristoranteProxy = new RistoranteProxy();
                ristoranteProxy.setNome(resultSet.getString("nome"));
                ristoranteProxy.setDescrizione(resultSet.getString("descrizione"));
                ristoranteProxy.setUbicazione(resultSet.getString("ubicazione"));
                ristoranti.add(ristoranteProxy);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
